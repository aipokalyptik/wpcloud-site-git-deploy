...
rm -rf "$fixture/wp-content/upgrade"
mkdir -p "$fixture/wp-content/blogs.dir"
printf 'multisite should not deploy\n' >"$fixture/wp-content/blogs.dir/file.txt"
sha="$(commit_fixture "E2E 17 shared blogs dir rejection")"
expect_update_failure e2e-17-shared-blogs-dir "shared path cannot be deployed: wp-content/blogs.dir"
log "- commit $sha"

rm -rf "$fixture/wp-content/blogs.dir"
sha="$(commit_fixture "E2E 18 shared path cleanup")"
deploy_update e2e-18-shared-cleanup "grep -Fx 'changed' /srv/htdocs/index.html; test ! -e /srv/htdocs/wp-content/uploads/file.jpg; test ! -e /srv/htdocs/.maintenance; test ! -e /srv/htdocs/wp-content/cache/object-cache.bin; test ! -e /srv/htdocs/wp-content/upgrade/package.tmp; test ! -e /srv/htdocs/wp-content/blogs.dir/file.txt"
log "- commit $sha"
